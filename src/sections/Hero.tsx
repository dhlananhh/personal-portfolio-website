  ...
  return (
    <div className="py-32 md:py-48 lg:py-60 relative z-0">
      ...
      <HeroOrbit size={430} rotation={-14}>
        <Images.StarIcon className="size-8 text-emerald-300/20" />
      </HeroOrbit>
      <HeroOrbit size={430} rotation={79}>
        <Images.StarIcon className="size-5 text-emerald-300/20" />
      </HeroOrbit>
      <HeroOrbit size={530} rotation={178}>
        <Images.StarIcon className="size-10 text-emerald-300/20" />
      </HeroOrbit>
      <HeroOrbit size={710} rotation={144}>
        <Images.StarIcon className="size-14 text-emerald-300/20" />
      </HeroOrbit>
